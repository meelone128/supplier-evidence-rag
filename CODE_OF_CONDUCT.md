...
team at [opensource@openai.com](mailto:opensource@openai.com). All complaints will be reviewed and
...
Maintainers will follow these guidelines in determining the consequences for any action they deem to
be in violation of this Code of Conduct:

1. **Correction** – Private, written warning clarifying the nature of the violation and explaining
   why the behavior was inappropriate.
2. **Warning** – Public warning for repeated or severe violations. The individual may be required to
   address the behavior directly with those affected.
3. **Temporary Ban** – Temporary removal from community spaces for behavior that violates the code.
4. **Permanent Ban** – Permanent removal from the project and community spaces for repeated or
