...
def _ensure_dotenv_precedence() -> None:
    ...
    variables for OPENAI_API_KEY, OPENAI_BASE_URL, OPENAI_ORG_ID, and OPENAI_PROJECT_ID. Using
...
def build_openai_client(cfg: RootConfig) -> OpenAI:
    ...
    base_url = resolve_env_placeholder(
        getattr(cfg.env, "openai_base_url", None)
